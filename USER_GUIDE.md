...
| `check_edit_safe` | Composite preflight check: is it safe to edit this symbol? Combines reference, signature, complexity, coverage, and production runtime history | `repo`, `symbol`, `cross_repo`, `include_runtime`, `storage_path` |
