...
| `patch_file` | Highly robust search-and-replace edit on a file, optionally constrained within AST boundaries of a specified symbol or a line range | `target_file`, `search_content`, `replace_content`, `folder_filter`, `file_filter`, `start_line`, `end_line`, `symbol_name`, `allow_multiple`, `line_filter`, `dry_run`, `storage_path` |
